# outliers 10%, concentrated pointwise contamination
...
# kmeans       0.35644659 0.6145665 0.08719509 0.002148271
# tclust      -0.01647309 0.7229775 0.49657884 0.001129558
#    PAM       0.30686847 0.6246848 0.11036618 0.001193647
# mclust      -0.04082400 0.7460346 0.43806613 0.001361648
#tkmeans       0.28791900 0.6265404 0.17645147 0.005644831
...
ri_tkmeans_s<-rand.index(dat$X1, t_t_K$cluster)
...
#Method       Silhouette_Score        RI       ARI       DI
# t-SNE + kmeans        0.6411738 0.6683196 0.2243912 0.000219
# t-SNE + tclust        0.3694255 0.6722955 0.3129270 0.000321
#    t-SNE + PAM        0.6372116 0.6666606 0.2203840 0.000181
# t-SNE + mclust        0.6411738 0.6699164 0.2462620 0.000072
#t-SNE + tkmeans        0.5393733 0.6726225 0.3118421 0.000563
...
#Method       Silhouette_Score        RI       ARI    DI
# UMAP + kmeans        0.6167446 0.2090105 0.2090105 0.00018
# UMAP + tclust        0.3255296 0.3609054 0.4631876 0.00012
#    UMAP + PAM        0.6082845 0.2082276 0.2082276 0.00010
# UMAP + mclust        0.7085716 0.2164177 0.2164177 0.00005
#UMAP + tkmeans        0.5393733 0.2170782 0.2691452 0.000162
...
#MDS+tclust
dis_ss = dist(mds_result)^2
clus_s <- tclust(mds_result, k = 4, alpha = 0.1, restr.fact = 100000)
